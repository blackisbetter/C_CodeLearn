...
/*
 * The bit-counting utility functions (count_num_of_1, count_dif_bit)
 * have been moved to shared/bit_utils.h and shared/bit_utils.c
 * as count_bits_set() and count_different_bits().
 *
 * Original implementations that were here:
 *   int count_num_of_1(unsigned int n)  -> count_bits_set(n)
 *   int count_dif_bit(unsigned int m, unsigned int n) -> count_different_bits(m, n)
 */
