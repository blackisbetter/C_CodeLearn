...
#include "../../shared/array_utils.h"
#include "../../shared/menu_utils.h"
#include <math.h>

/*
 * The following functions have been moved to shared utilities:
 *   is_prime(n)         -> is_prime(n)         [shared/math_utils.h]
 *   is_leap_year(year)  -> is_leap_year(year)  [shared/math_utils.h]
 *   binum_search(...)   -> binary_search(...)  [shared/array_utils.h]
 *   menu()              -> show_game_menu()    [shared/menu_utils.h]
 */
